...
url='https://drop.domain.tld/' # Or set JIRAFEAU_URL.
time='hour' # Or set JIRAFEAU_TIME.
one_time='' # Or set JIRAFEAU_ONE_TIME.
curl='' # Or set JIRAFEAU_CURL_PATH.
upload_password='password' # Or set JIRAFEAU_UPLOAD_PASSWD
# Config end
...
if [ -z "$2" ]; then
    echo "Jirafeau Bash Script 4.3.0"
    echo "--------------------------"
    echo "Usage:"
    echo "    $0 OPTIONS"
    echo
